...
from service.caribbeancom_pr import service_caribbeancompr_api

environments.is_local_debugging = True  # this is needed
reload(service_caribbeancompr_api)


class Test(TestCase):

    def test_get_item(self):
        item = service_caribbeancompr_api.get_item("091616-007")
    ...
    def test_get_item_2(self):
        item = service_caribbeancompr_api.get_item("032715-157")
    ...
    def test_get_item_without_series(self):
        item = service_caribbeancompr_api.get_item("052716-172")
    ...
    def test_extract_id(self):
        self.assertEqual("123123-233", service_caribbeancompr_api.extract_id("carib-123123-233"))
        self.assertEqual("123123-233", service_caribbeancompr_api.extract_id("Carib-123123-233"))
        self.assertEqual("123123-233", service_caribbeancompr_api.extract_id("Carib-123123-233-asd"))
        self.assertEqual("123123-233", service_caribbeancompr_api.extract_id("Carib-123123-233-FHD"))
        self.assertEqual(None, service_caribbeancompr_api.extract_id("Carib-12123-233-FHD"))
        self.assertEqual("123123-23123123", service_caribbeancompr_api.extract_id("Carib-123123-23123123-FHD"))
        self.assertEqual("123123-1", service_caribbeancompr_api.extract_id("Carib-123123-1-FHD"))
        self.assertEqual("123123-1", service_caribbeancompr_api.extract_id("Caribbean-123123-1-FHD"))
        self.assertEqual("123123-1", service_caribbeancompr_api.extract_id("Caribbeancom-123123-1-FHD"))
        self.assertEqual(None, service_caribbeancompr_api.extract_id("Caribb-123123-1-FHD"))
        self.assertEqual(None, service_caribbeancompr_api.extract_id("Caribbeanc-123123-1-FHD"))

    def test_has_valid_id(self):
        self.assertEqual(True, service_caribbeancompr_api.has_valid_id("carib-123123-233"))
        self.assertEqual(True, service_caribbeancompr_api.has_valid_id("Carib-123123-233"))
        self.assertEqual(True, service_caribbeancompr_api.has_valid_id("Carib-123123-233-asd"))
        self.assertEqual(True, service_caribbeancompr_api.has_valid_id("Carib-123123-233-FHD"))
        self.assertEqual(False, service_caribbeancompr_api.has_valid_id("Carib-12123-233-FHD"))
        self.assertEqual(True, service_caribbeancompr_api.has_valid_id("Carib-123123-23123123-FHD"))
        self.assertEqual(True, service_caribbeancompr_api.has_valid_id("Carib-123123-1-FHD"))
        self.assertEqual(True, service_caribbeancompr_api.has_valid_id("Caribbean-123123-1-FHD"))
        self.assertEqual(True, service_caribbeancompr_api.has_valid_id("Caribbeancom-123123-1-FHD"))
        self.assertEqual(False, service_caribbeancompr_api.has_valid_id("Caribb-123123-1-FHD"))
        self.assertEqual(False, service_caribbeancompr_api.has_valid_id("Caribbeanc-123123-1-FHD"))
