...
class Test(TestCase):
    ...
    def test_extract_filename_without_ext_and_part_number(self):
        ...
        self.assertEqual("assdf",
                         file_helper.extract_filename_without_ext_and_part_number("/aaa/assdf-part534"))
        self.assertEqual("adffpart534",
                         file_helper.extract_filename_without_ext_and_part_number("/aaaa/adffpart534"))
        self.assertEqual("", file_helper.extract_filename_without_ext_and_part_number("/aaaaa/-part534.mp4"))
        self.assertEqual("asdsdf",
                         file_helper.extract_filename_without_ext_and_part_number("/aaaaa/asdsdf-part54.mp4"))
        self.assertEqual("dafpart534",
                         file_helper.extract_filename_without_ext_and_part_number("/aaa/dafpart534.mp4"))
        ...
        self.assertEqual("aaaaapart534",
                         file_helper.extract_filename_without_ext_and_part_number("/aaaaapart534"))
    ...
    def test_extract_product_id_and_part_number(self):
        ...
        self.assertEqual(('', 534), file_helper.extract_product_id_and_part_number("/aaaaa/-part534"))
        self.assertEqual(('asdfasdf', 534),
                         file_helper.extract_product_id_and_part_number("/aaaaa/asdfasdf-part534"))
        ...
        self.assertEqual(('asdfdf', 534),
                         file_helper.extract_product_id_and_part_number("/aaaaa/asdfdf-part534.mp4"))
