...
def tail_log():
    ...
    if platform.system().lower() == 'darwin':
        ...
        color_debug = '/DEBUG/ {print "\033[35m" $0 "\033[39m"; next}'
        color_info = '/INFO/ {print "\033[39m" $0 "\033[39m"; next}'
        color_warn = '/WARN/ {print "\033[33m" $0 "\033[39m"; next}'
        color_error = '/ERROR/ {print "\033[31m" $0 "\033[39m"; next}'
